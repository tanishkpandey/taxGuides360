const CallToAction = () => {
  ...
  <div className="container px-5 py-5">
    <div className=" flex flex-col justify-between sm:justify-between sm:flex-row sm:items-center items-start">
      ...
      <button className="flex-shrink-0 text-[#0787FB] border-0 py-2 px-8 focus:outline-none hover:opacity-95 rounded-xl text-lg mt-10 sm:mt-0 bg-typography-light">Register</button>
    </div>
  </div>
</section>
        </div>
