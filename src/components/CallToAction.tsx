          ...
          <section className="text-gray-600 body-font bg-[#167733]">
            <div className="container px-5 py-5">
              <div className=" flex flex-col justify-between sm:justify-between sm:flex-row sm:items-center items-start">
                ...
                <Link to='/contactus' className="flex-shrink-0 text-[#167733] border-0 py-2 px-8 focus:outline-none hover:opacity-95 rounded-lg text-lg mt-10 sm:mt-0 bg-typography-light">Register</Link>
              </div>
            </div>
          </section>
      </div>
