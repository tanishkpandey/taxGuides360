...
<footer>
    <div className=" bg-[#ffffff] mx-auto w-full p-4 py-6 lg:py-8 border-t-2">
      ...
      <hr className="my-6 border-gray-200 sm:mx-auto    lg:my-8 container" />
      <div className="sm:flex sm:items-center sm:justify-between container">
          <span className="text-sm text-gray-500 sm:text-center    ">© 2024 TaxGuides360 | All Rights Reserved
          </span>
