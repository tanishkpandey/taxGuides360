...
const OurTeam = () => {
    return (
        <section className="text-gray-600 body-font bg-[#ffff]">
            <div className="container px-5 py-24 mx-auto">
              ...
              </h1>                    <p className="lg:w-2/3 mx-auto leading-6 text-base"> Get to know the individuals who make our company thrive from our dedicated developers to our visionary designers, each member of our team plays a crucial role in shaping our success story.</p>
                </div>
