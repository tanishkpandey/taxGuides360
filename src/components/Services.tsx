const Services = () => {
    return(
        <>
        <section class="text-gray-600 body-font bg-[#ffffff]">
  ...
  <div class="container mx-auto flex flex-wrap">
    <h2 class="sm:text-4xl text-3xl text-gray-900 text-left title-font mb-2 md:w-2/5 font-bold text-typography-dark">Explore Our <br/>Extensive Services</h2>
    <div class="md:w-3/5 md:pl-6">
      <p class="leading-relaxed text-base text-left">Taxidermy bushwick celiac master cleanse microdosing seitan. Fashion axe four dollar toast truffaut, direct trade kombucha brunch williamsburg keffiyeh gastropub tousled squid meh taiyaki drinking vinegar tacos.</p>
