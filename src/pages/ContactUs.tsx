const ContactUs = () => {
  return (
    <>
      <section className="text-gray-600 body-font relative bg-[#f6f6f6]">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-7 rounded-xl border">
            <h2 className="text-gray-900 text-lg mb-1 title-font mb-4 font-bold text-typography-dark text-lg">Contact us</h2>
            <p className="leading-relaxed mb-5 text-gray-600">We'd love to hear from you! Please fill out the form below to get in touch.</p>
